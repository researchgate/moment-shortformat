...
test('test seconds ago with suffix', function (t) {
    t.plan(1);
    t.equal(moment().subtract(25, 'seconds').short(), '25s ago');
});

test('test seconds in future with prefix', function (t) {
    t.plan(1);
    t.equal(moment().add(25, 'seconds').short(), 'in 25s');
});

test('test minutes ago with suffix', function (t) {
    t.plan(1);
    t.equal(moment().subtract(5, 'minutes').short(), '5m ago');
});

test('test minutes in future with prefix', function (t) {
    t.plan(1);
    t.equal(moment().add(5, 'minutes').short(), 'in 5m');
});

test('test hours ago with suffix', function (t) {
    t.plan(1);
    t.equal(moment().subtract(5, 'hours').short(), '5h ago');
});

test('test hours in future with prefix', function (t) {
    t.plan(1);
    t.equal(moment().add(5, 'hours').short(), 'in 5h');
});

test('test days ago with suffix', function (t) {
    t.plan(1);
    t.equal(moment().subtract(5, 'days').short(), '5d ago');
});

test('test days in future with prefix', function (t) {
    t.plan(1);
    t.equal(moment().add(5, 'days').short(), 'in 5d');
});
